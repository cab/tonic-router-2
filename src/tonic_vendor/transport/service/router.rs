...
where
    ...
    A::Error: Into<crate::tonic_vendor::Error>,
    B: Service<Request, Response = A::Response>,
    B::Future: Send + 'static,
    B::Error: Into<crate::tonic_vendor::Error>,
{
    ...
    B::Error: Into<crate::tonic_vendor::Error>,
{
    ...
    type Future = Either<
        MapErr<A::Future, fn(A::Error) -> crate::tonic_vendor::Error>,
        MapErr<B::Future, fn(B::Error) -> crate::tonic_vendor::Error>,
    >;
