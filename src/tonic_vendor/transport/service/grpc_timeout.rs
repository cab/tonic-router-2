...
// use tonic::util::{OptionPin, OptionPinProj};
...
{
    type Output = Result<Res, crate::tonic_vendor::Error>;
...
///
/// [`Endpoint::timeout`]: super::super::server::Server::timeout
/// [`Server::timeout`]: super::super::channel::Endpoint::timeout
