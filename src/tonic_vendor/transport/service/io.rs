use super::super::server::Connected;
...
pub(in super::super) trait Io: AsyncRead + AsyncWrite + Send + 'static {}
...
impl BoxedIo {
    pub(in super::super) fn new<I: Io>(io: I) -> Self {
        BoxedIo(Box::pin(io))
    }
}
...
impl<IO> ServerIo<IO> {
    pub(in super::super) fn new_io(io: IO) -> Self {
        Self::Io(io)
    }

    #[cfg(feature = "tls")]
    pub(in super::super) fn new_tls_io(io: TlsStream<IO>) -> Self {
        Self::TlsIo(io)
    }

    #[cfg(feature = "tls")]
    pub(in super::super) fn connect_info(&self) -> ServerIoConnectInfo<IO>
    where
        IO: Connected,
