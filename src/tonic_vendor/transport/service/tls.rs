...
impl TlsConnector {
    ...
    pub(crate) fn new_with_rustls_cert(
        ...
        domain: String,
    ) -> Result<Self, crate::tonic_vendor::Error> {
    ...
    pub(crate) async fn connect<I>(&self, io: I) -> Result<BoxedIo, crate::tonic_vendor::Error>
    where
...
impl TlsAcceptor {
    ...
    pub(crate) async fn accept<IO>(&self, io: IO) -> Result<TlsStream<IO>, crate::tonic_vendor::Error>
    where
...
mod rustls_keys {
    ...
    use super::super::service::tls::TlsError;
    use super::super::Identity;

    fn load_rustls_private_key(
        mut cursor: std::io::Cursor<&[u8]>,
    ) -> Result<PrivateKey, crate::tonic_vendor::Error> {
    ...
    pub(crate) fn load_identity(
        identity: Identity,
    ) -> Result<(Vec<Certificate>, PrivateKey), crate::tonic_vendor::Error> {
        let cert = {
