use super::super::service::ServerIo;
...
pub(crate) fn tcp_incoming<IO, IE, L>(
    ...
    _server: Server<L>,
) -> impl Stream<Item = Result<ServerIo<IO>, crate::tonic_vendor::Error>>
where
...
async fn select<IO, IE>(
    ...
    tasks: &mut futures_util::stream::futures_unordered::FuturesUnordered<
        tokio::task::JoinHandle<Result<ServerIo<IO>, crate::tonic_vendor::Error>>,
    >,
) -> SelectOutput<IO>
where
    IE: Into<crate::tonic_vendor::Error>,
