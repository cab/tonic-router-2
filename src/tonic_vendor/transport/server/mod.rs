...
pub(crate) use incoming::TcpIncoming;
...
type BoxHttpBody = http_body::combinators::BoxBody<Bytes, crate::tonic_vendor::Error>;
type BoxService =
    tower::util::BoxService<Request<Body>, Response<BoxHttpBody>, crate::tonic_vendor::Error>;
...
where
    ...
    S::Error: Into<crate::tonic_vendor::Error> + Send,
{
    type Response = Response<BoxBody>;
    type Error = crate::tonic_vendor::Error;

    #[allow(clippy::type_complexity)]
    type Future = MapErr<S::Future, fn(S::Error) -> crate::tonic_vendor::Error>;
...
impl<L> Server<L> {
    ...
    where
        ...
        <<L as Layer<S>>::Service as Service<Request<Body>>>::Error:
            Into<crate::tonic_vendor::Error> + Send,
        I: Stream<Item = Result<IO, IE>>,
        IO: AsyncRead + AsyncWrite + Connected + Unpin + Send + 'static,
        IO::ConnectInfo: Clone + Send + Sync + 'static,
        IE: Into<crate::tonic_vendor::Error>,
        F: Future<Output = ()>,
        ResBody: http_body::Body<Data = Bytes> + Send + Sync + 'static,
        ResBody::Error: Into<crate::tonic_vendor::Error>,
    {
        ...
        let incoming = accept::from_stream::<_, _, crate::tonic_vendor::Error>(tcp);
...
where
    ...
    A::Error: Into<crate::tonic_vendor::Error> + Send,
    B: Service<Request<Body>, Response = Response<BoxBody>> + Clone + Send + 'static,
    B::Future: Send + 'static,
    B::Error: Into<crate::tonic_vendor::Error> + Send,
{
...
where
    ...
    ResBody::Error: Into<crate::tonic_vendor::Error>,
{
    type Output = Result<Response<BoxHttpBody>, crate::tonic_vendor::Error>;
